...
abstract contract FeatureFlag {
    ...
    uint256 internal constant NO_VOUCHER_BIT = 1 << 7;
    ...
    /**
     * @dev A helper function to check if a feature is enabled.
     */
    modifier onlyAllowedFeature(uint256 flagGroup, uint256 notMatchBits) virtual {
        _requireFeaturesEnabled(flagGroup, notMatchBits);
        _;
    }
}
